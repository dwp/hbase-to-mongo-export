...
class ValidatorTest {
    ...
    fun Should_Return_Timestamp_Of_Valid_Date_When_Parseable() {
        ...
        val actual = validator.getLastModifiedDateTimeAsLong(validDate)
        assertEquals(expected, actual)
    }

    @Test
    fun Should_Return_Timestamp_Of_Epoch_When_Not_Parseable() {
        val invalidDate = "2018-12-14T15:01:02"
        val expected = 315532800000L
        val actual = validator.getLastModifiedDateTimeAsLong(invalidDate)
        assertEquals(expected, actual)
