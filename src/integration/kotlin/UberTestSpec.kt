...
class UberTestSpec: StringSpec() {
    ...
    init {
        ...
        "Correct data egress messages sent" {
            ...
            val firstExpected = """{"Records":["s3":{"object":{"key":"equality/data.equality-/pipeline_success.flag"}}]}"""
            val secondExpected = """{"Records":["s3":{"object":{"key":"output/db.database.collection-/pipeline_success.flag"}}]}"""
