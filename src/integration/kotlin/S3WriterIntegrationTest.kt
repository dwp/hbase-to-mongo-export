...
class S3WriterIntegrationTest {
    ...
    fun testMethod() {
        ...
        val date = "\$date"
        val expected = """
            |"{""_lastModifiedDateTime"":{""$date"":""2013-08-05T02:10:19.887Z""},""_removedDateTime"":{""$date"":""2011-08-05T02:10:19.887Z""},""createdDateTime"":{""$date"":""2010-08-05T02:10:19.000Z""},""declarationId"":1234,""someId"":""RANDOM_GUID""}"|1426854205183|penalties-and-deductions|sanction|EXPORT|V4|"{""_lastModifiedDateTime"":""2013-08-05T02:10:19.887+0000"",""_removedDateTime"":""2011-08-05T02:10:19.887+0000"",""createdDateTime"":""2010-08-05T02:10:19.000+0000"",""declarationId"":1234,""someId"":""RANDOM_GUID""}"|MONGO_INSERT
